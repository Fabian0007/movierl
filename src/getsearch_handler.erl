...
handle(Req, State) ->
    ...
    {ok, {{_Version, 200, _ReasonPhrase}, _Headers, Body}} = httpc:request(get, {?Url ++ "/search/multi?api_key=" ++ ?ApiKey ++ "&query=" ++ SearchS ++ "&page=" ++ PageS ++ "&include_adult=false", []}, [], []),
